...
public class TestClass_MakerCheckerFlow_ForSameEntity_DealWithTemplate extends BaseTest {

	@Test(priority = 1)
	public void Verify_Select_Entity() throws Exception {

		deal_with_template.select_Entity(UtilityClass.getDatafromPropertyFile("EntityName_MakerCheker"));
	...
	public void Verify_Select_Product() throws Exception {
		...
		deal_with_template.select_Product(UtilityClass.getDatafromPropertyFile("ProgramName_ForAutoSign"));
