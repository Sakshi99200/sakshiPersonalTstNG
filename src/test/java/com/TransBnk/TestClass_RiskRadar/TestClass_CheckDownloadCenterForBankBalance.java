...
public class TestClass_CheckDownloadCenterForBankBalance extends BaseTest {
	@Test(priority = 1)
	...
	public void Verify_ClickExportButtonOnBankBalancePage() throws InterruptedException {
		...
		checkDownloadCenterForBankBalance.clickOnExportButtonOnBankBalancePage();
	...
	public void Verify_BankBalanceStatusinDownloadCenterForBankBalance() throws InterruptedException {
		...
		checkDownloadCenterForBankBalance.checkStatusInDownloadCenterForBankBalanceReport();
	}
