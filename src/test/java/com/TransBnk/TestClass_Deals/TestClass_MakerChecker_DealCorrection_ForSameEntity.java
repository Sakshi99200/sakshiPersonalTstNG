...
public class TestClass_MakerChecker_DealCorrection_ForSameEntity extends BaseTest {

	@Test(priority = 1)
	public void Verify_Select_Entity() throws Exception {

		deal_without_template.select_Entity(UtilityClass.getDatafromPropertyFile("EntityName_MakerCheker"));
	...
	public void Verify_Select_Product() throws Exception {
		...
		deal_without_template.select_Product(UtilityClass.getDatafromPropertyFile("ProgramName_For_makerChecker"));
...
//		deal_without_HandlingNegativeScnarios.Invalid_Input_DateofBirth();
	...
	@Test(priority = 24)
	public void Verify_DealReturnForCorrectionFlow() throws Exception {

		makercheckerFlow_forsameEntity.ReturnDealForCorrection();

	}

	@Test(priority = 25)
	public void ClickOn_DocuflowOption() throws InterruptedException {
	...
	public void EditPartyDetails_andClickOnproceedButton() throws Exception {

		makercheckerFlow_forsameEntity.ClickOnProceedButton();

		makercheckerFlow_forsameEntity.Edit_partyDetails_forDealCorrection();
	}

	@Test(priority = 29)

	public void performActionsBasedOnDealRefID_afterDealCorrection() throws Exception {
		deal_without_template.performActionsBasedOnDealRefID();

	}

	@Test(priority = 30)
	public void ClickOnSendForVerificationButton() throws Exception {
	...
	@Test(priority = 31)
	public void ClickOnDocuflowOption_() throws InterruptedException {
	...
	public void ClickOn_DealVerificationOption_() throws InterruptedException {
		makercheckerFlow_forsameEntity.ClickOnDealVerificationOption();
	}

	@Test(priority = 33)

	public void PerformActionBasedOnDealID_ForDeal_VerificationAfterDealCorrection() throws Exception {
