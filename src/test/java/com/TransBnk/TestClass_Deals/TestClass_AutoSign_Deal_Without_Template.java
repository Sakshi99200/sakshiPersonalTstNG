...
public class TestClass_AutoSign_Deal_Without_Template extends BaseTest {

	@Test(priority = 1)
	public void Verify_Select_Entity() throws Exception {

		deal_without_template.select_Entity(UtilityClass.getDatafromPropertyFile("EntityName_ForAutoSign"));
	...
	public void Verify_Select_Product() throws Exception {
		...
		deal_without_template.select_Product(UtilityClass.getDatafromPropertyFile("ProgramName_ForAutoSign"));
...
// *** deleted
//	@Test(priority = 3)
//	public void ClickOnClickOnDocuflow() throws InterruptedException {
//
//		deal_without_template.ClickOnDocuflowOption();
//
//	}
//
//	@Test(priority = 18)
//	public void Verify_ClickOnDealVerificationOption() throws Exception {
//
