...
public class TestClass_AutoSign_MakerChekerFlow_forDifferentEntity extends BaseTest {

	@Test(priority = 1)
	public void Verify_Select_Entity() throws Exception {

		deal_without_template
				.select_Entity(UtilityClass.getDatafromPropertyFile("EntityName_AutoSignMakerCheker_Diff_Entity"));
