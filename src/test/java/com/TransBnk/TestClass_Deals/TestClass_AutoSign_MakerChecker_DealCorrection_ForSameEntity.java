...
public class TestClass_AutoSign_MakerChecker_DealCorrection_ForSameEntity extends BaseTest {
	...
	public void Verify_Deal_creation_page() throws Exception {
		...
		deal_without_template.Select_productName(UtilityClass.getDatafromPropertyFile("ProductName_ForAutoSign"));
...
//		deal_without_HandlingNegativeScnarios.Invalid_Input_DateofBirth();
	...
	public void EditPartyDetails_andClickOnproceedButton() throws Exception {
		...
		System.out.println("EditPartyDetails_andClickOnproceedButton");
